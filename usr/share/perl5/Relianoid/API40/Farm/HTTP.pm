...
sub del_addheader ($farmname, $index) {
...
#  DELETE	/farms/<>/addheader/<>
sub del_headremove ($farmname, $index) {
...
sub del_addResponseheader ($farmname, $index) {
...
sub add_replaceheader ($json_obj, $farmname, $type) {
    ...
    unless (&addHTTPReplaceHeaders(
        $farmname, $json_obj->{type}, $json_obj->{header}, $json_obj->{match}, $json_obj->{replace}))
    {
...
sub modify_replaceRequestHeader ($json_obj, $farmname, $index) {
    my $type = "Request";
    return &modify_replaceHeader($json_obj, $farmname, $type, $index);
}

#  PUT	/farms/<>/replaceresponseheader/<>
sub modify_replaceResponseHeader ($json_obj, $farmname, $index) {
    my $type = "Response";
    return &modify_replaceHeader($json_obj, $farmname, $type, $index);
}
...
sub modify_replaceHeader ($json_obj, $farmname, $type, $index) {
    ...
    unless (&modifyHTTPReplaceHeaders(
        $farmname, $type,
...
sub del_replaceRequestHeader ($farmname, $index) {
    my $type = "Request";
    return &del_replaceheader($farmname, $index, $type);
}

#  DELETE	/farms/<>/replaceresponseheader/<>
sub del_replaceResponseHeader ($farmname, $index) {
    my $type = "Response";
    return &del_replaceheader($farmname, $index, $type);
}

sub del_replaceheader ($farmname, $index, $type) {
...
sub move_replacerequestheader ($json_obj, $farmname, $index) {
    my $type  = "Request";
...
sub move_replaceresponseheader ($json_obj, $farmname, $index) {
    my $type  = "Response";
...
sub modify_removeResponseheader ($json_obj, $farmname, $index) {
...
#  DELETE	/farms/<>/addheader/<>
sub del_removeResponseHeader ($farmname, $index) {
