...
#### OPTIONS requests ################################################
require Relianoid::API31::Routes::Options if ($ENV{REQUEST_METHOD} eq 'OPTIONS');

##### Authentication #################################################
require Relianoid::API31::Auth;
require Relianoid::Zapi;

# Session request
require Relianoid::API31::Routes::Session if ($q->path_info eq '/session');
...
require Relianoid::API31::Routes;
